...
String TTS_INPUT_1 = "Step 1: Find the difference between 100 and the number. Subtract the difference from the number and multiply it by 100.";
String TTS_INPUT_2 = "Paso 1: Encuentra la diferencia entre 100 y el número. Resta la diferencia del número y multiplícalo por 100.";
