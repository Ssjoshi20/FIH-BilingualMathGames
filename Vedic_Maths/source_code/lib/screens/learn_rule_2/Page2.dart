...
import 'package:vedicmath/screens/learn_rule_2//components/page2/flippable_card.dart';
import 'package:vedicmath/screens/learn_rule_2//components/page2/flippable_card2.dart';
...
import 'package:vedicmath/screens/learn_rule_2//quiz.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => const LearnScreen_1()));},
