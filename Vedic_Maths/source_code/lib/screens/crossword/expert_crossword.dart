...
class ExpertCrosswordScreen extends StatefulWidget {
  const ExpertCrosswordScreen({Key? key}) : super(key: key);

  @override
  State<ExpertCrosswordScreen> createState() => _ExpertCrosswordScreenState();
}

class _ExpertCrosswordScreenState extends State<ExpertCrosswordScreen> {
  ...
  // Expert difficulty questions based on Vedic math rules
  final List<String> questions = [
    "11111 squared",          // Square of numbers made of 1
    "111111 squared",         // Square of numbers made of 1
    "17 * 18",                // Multiplication of two numbers between 10-20
    "19 * 19",                // Multiplication of two numbers between 10-20
    "275 divided by 5",       // Division by 5
    "365 divided by 5",       // Division by 5
    "101 squared",            // Square of numbers near 100
    "109 squared",            // Square of numbers near 100
    "95 squared",             // Square of numbers ending with 5
    "105 squared",            // Square of numbers ending with 5
  ];

  final List<String> answers = [
    "123454321",             // 11111 squared
    "12345654321",           // 111111 squared
    "306",                   // 17 * 18
    "361",                   // 19 * 19
    "55",                    // 275 divided by 5
    "73",                    // 365 divided by 5
  ...
  void selectRandomQuestionsAndAnswers() {
    ...
    while (selectedIndices.length < 10) { // Select 10 questions for expert level
  ...
  bool canPlaceWord(String answer, List<List<String>> grid, int row, int col, bool horizontal) {
    if (horizontal) {
      if (col + answer.length > 11) return false; // Out of bounds
      ...
      if (row + answer.length > 11) return false; // Out of bounds
      for (int i = 0; i < answer.length; i++) {
  ...
  List<List<String>> generateCrossword() {
    List<List<String>> grid = List.generate(11, (_) => List.generate(11, (_) => ""));
    final random = Random();
                ...
                children: [
                  Expanded(
                    ...
                    child: Crossword(
                      ...
                      allowOverlap: true,
                      letters: grid,
                      spacing: const Offset(50, 50), // Adjusted for smaller size
                      ...
                      textStyle: const TextStyle(
                        color: Colors.white,
                        fontSize: 24,  // Reduced font size for the grid
                        fontWeight: FontWeight.bold,
                      ),
                      lineDecoration: const LineDecoration(
                        ...
                        strokeWidth: 18,  // Adjusted stroke width
