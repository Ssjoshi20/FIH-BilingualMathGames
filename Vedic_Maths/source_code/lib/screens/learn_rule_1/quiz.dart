...
import 'package:vedicmath/screens/learn_rule_1/Page2.dart';
...
class _QuizWidgetState extends State<QuizWidget> {
  ...
  final Map<String, Object> _question = {
    'questionText': 'Seventy Five Squared',
    'questionNum': '75 * 75',
    'correctAnswer': 'Five thousand Six hundred and Twenty Five',
    'correctAnsNum': '5625',
  };
  ...
  final List<String> _ansNum = ['5625', '4025', '3005', '42'];
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child:
                            const Text('Back', style: TextStyle(fontSize: 28)),
                      ),
                      ElevatedButton(
                        onPressed: !_isAnswerCorrect || !_isSubmitted
                            ...
                            : _nextQuestion,
                        child:
                            const Text('Next', style: TextStyle(fontSize: 28)),
                      ),
                    ],
                  ),
                ],
