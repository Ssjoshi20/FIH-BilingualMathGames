...
String TTS_INPUT_1 =
    "Step 2: Count from 1 to the total number of ones and then back down to 1.";
String TTS_INPUT_2 =
    "Paso 2: Cuenta desde 1 hasta el total de unos y luego retrocede hasta llegar a 1";
